...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['fetch_age_data'])) {
    $query = "SELECT CASE
            ...
            COUNT(*) AS total
            FROM user_profile
            INNER JOIN eco_sec ON user_profile.parent_id = eco_sec.parent_id
            WHERE user_profile.approval_status = 'approved' 
            AND (eco_sec.own_pension_type IS NULL OR eco_sec.own_pension_type = '')
...
<head>
  ...
  <title>Graphical Without Pensions</title>
  ...
  <link rel="stylesheet" href="../Admin/admin_css/GraphicalR-Withoutpen.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
                <a class="nav-link collapsed" data-bs-target="#graphical-reports-nav" data-bs-toggle="collapse" href="Report-Graphical-WithoutPension.php">
                ...
                <ul id="graphical-reports-nav" class="nav-content collapse show">
                  <li>
                    ...
                    <li>
                        <a href="Reports-Graphical-WithoutPension.php" class="active">
    ...
    <section class="pension-report-section">
      <div class="report-content">
          <div class="report-table">
              <h2 style="font-weight: bold;">Report By Without Pensions</h2>
          ...
          <div class="graph">
              ...
              <h2>Graphical Representation Without Pension</h2>
...
document.addEventListener('DOMContentLoaded', () => {
  fetch('Report-Graphical-WithoutPension.php?fetch_age_data=true')
...
function printSection() {
  ...
  // Call the generateAgeChart function when the page loads
  window.onload = generateAgeChart;
