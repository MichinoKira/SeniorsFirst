...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a  class="nav-link collapsed" data-bs-target="#components-nav" href="reg-seniors.php">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#components-nav"  href="archive_list.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <div class="pagetitle-content">
          <img src="../Admin/admin_css/img/regs-logo.PNG" alt="Dashboard Icon" class="page-icon">
          <h1>Archive Lists</h1>
      </div>
      <nav>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Archive Lists</li>
          </ol>
      </nav>
  </div><!-- End Page Title -->
